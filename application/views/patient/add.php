...
<body>
    ...
    <div class="container mt-5">
        ...
        <?php echo form_open('patient/add', ['enctype' => 'multipart/form-data']); ?>
        ...
        <div class="mb-3">
            ...
            <input type="file" class="form-control" id="profile_image" name="profile_image" value="<?php echo set_value('profile_image'); ?>">
        </div>
