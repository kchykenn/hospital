...
<html
  ...
  <head>
    ...
    <title>Register EMR Web Training</title>
    ...
    <div class="position-relative">
      <div class="authentication-wrapper authentication-basic container-p-y">
        <div class="authentication-inner py-6 mx-4">
          ...
          <div class="card p-7">
            <!-- Logo -->
            <?php echo form_open('user/register', ['enctype' => 'multipart/form-data']); ?>
            ...
            <div class="card-body mt-1">
              <h4 style="text-align: center;" class="mb-1">Create Account! 👋🏻</h4>
              <p  style="text-align: center;" class="mb-5">Please sign-Up to create an Account</p>
            ...
            <?php echo form_open('user/login'); ?>
              ...
              <div class="form-floating form-floating-outline mb-5">
                  <input
                    ...
                    id="firstname"
                    name="firstname"
                    required value="<?php echo set_value('firstname'); ?>"
                ...
                <div class="form-floating form-floating-outline mb-5">
                  <input
                    ...
                    id="lastname"
                    name="lastname"
                    required value="<?php echo set_value('lastname'); ?>"
